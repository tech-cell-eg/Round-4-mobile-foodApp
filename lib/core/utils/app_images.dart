abstract class AppImages
{
  ...
  static const String logo = "${basePath}fruit_hub_icon.svg";
  static const String fruitBasket1 = "${basePath}fruit_basket_1.png";
  ...
  static const String complete = "${basePath}Animation - 1750769806803.json";
}